...
void Misc::updateClanTag(bool tagChanged) noexcept
{
    ...
    if (config->misc.clantag)
    {
        ...
        if (time != lastTime)
        {
            switch (time % 7)
            {
            case 0: { memory->setClanTag(skCrypt(" P "), skCrypt(" P ")); break; }
            case 1: { memory->setClanTag(skCrypt(" Pa "), skCrypt(" Pa ")); break; }
            case 2: { memory->setClanTag(skCrypt(" Pas "), skCrypt(" Pas ")); break; }
            case 3: { memory->setClanTag(skCrypt(" Pasta "), skCrypt(" Pasta ")); break; }
            case 4: { memory->setClanTag(skCrypt(" Pastah "), skCrypt(" Pastah ")); break; }
            case 5: { memory->setClanTag(skCrypt(" Pastahook "), skCrypt(" Pastahook ")); break; }
            case 6: { memory->setClanTag(skCrypt(" Pastahook "), skCrypt(" Pastahook ")); break; }
            }
